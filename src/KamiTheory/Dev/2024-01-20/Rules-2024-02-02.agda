...
module KamiTheory.Dev.2024-01-20.Rules-2024-02-02 where
...
data _⊢Space : ∀ (Γ : Ctx) -> 𝒰₀
data _⊢Sheaf_ : ∀ (Γ : Ctx) -> (Γ ⊢Space) -> 𝒰₀
...
data Ctx where
  [] : Ctx
  _,[_] : ∀ (Γ : Ctx) -> (A : Γ ⊢Type) -> Ctx
  _,[_]ₛ : ∀ (Γ : Ctx) -> (A : Γ ⊢Space) -> Ctx

infixl 30 _,[_] _,[_]ₛ

wk-Type : Γ ⊢Type -> Γ ,[ B ] ⊢Type
wk-Type = {!!}
